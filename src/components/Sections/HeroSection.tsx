        ...
        <div className="max-w-4xl">
          ...
          <div className="bg-navy-deep/95 backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-2xl border border-white/10">
            ...
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium">Suffolk County's #1 EV Charger Experts</span>
            </div>

            {/* Main Heading */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              EV Charger Installation{" "}
              <span className="text-electric-green">Suffolk County</span>
            </h1>
            ...
            <div className="mt-8 pt-8 border-t border-white/20">
              <p className="text-sm text-white/70 mb-4">Trusted by 500+ Suffolk County homeowners</p>
